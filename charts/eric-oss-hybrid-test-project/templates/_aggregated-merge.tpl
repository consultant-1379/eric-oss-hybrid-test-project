...
*/ -}}
{{- define "eric-oss-hybrid-test-project.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-oss-hybrid-test-project.mergeAnnotations" -}}
  {{- include "eric-oss-hybrid-test-project.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-oss-hybrid-test-project.mergeLabels" -}}
  {{- include "eric-oss-hybrid-test-project.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
