# Contributing to Test project of etopemi

This document describes how to contribute to the Test project of etopemi Project.
...
Test project of etopemi artifacts are stored in the Gerrit project: [OSS/com.ericsson.oss.ci.test/eric-oss-hybrid-test-project](https://gerrit.ericsson.se/#/admin/projects/OSS/com.ericsson.oss.ci.test/eric-oss-hybrid-test-project)
  
### Documents

The documentation for this service is located in the [doc folder](https://gerrit.ericsson.se/plugins/gitiles/OSS/com.ericsson.oss.ci.test/eric-oss-hybrid-test-project/+/master/doc).

To update documents that are not in the referenced folder, contact the service guardians mentioned in the [README.md](https://gerrit.ericsson.se/plugins/gitiles/OSS/com.ericsson.oss.ci.test/eric-oss-hybrid-test-project/+/master/README.md).
...
The code-review scores and corresponding workflow activities are as follows:
   ...
   [README.md] (https://gerrit.ericsson.se/plugins/gitiles/OSS/com.ericsson.oss.ci.test/eric-oss-hybrid-test-project/+/master/README.md)